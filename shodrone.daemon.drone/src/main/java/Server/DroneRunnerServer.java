...
public class DroneRunnerServer {
    private static final Logger LOGGER = LogManager.getLogger(DroneRunnerServer.class);

    private final BlockingQueue<RequestMessage> requestQueue;

    public DroneRunnerServer(final BlockingQueue<RequestMessage> requestQueue) {
