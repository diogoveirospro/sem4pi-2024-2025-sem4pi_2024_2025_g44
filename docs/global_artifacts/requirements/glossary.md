...
| Catalogue               | The collection of figures that can be chosen by the customer.                                                                   |
...
| Customer Status         | Represents the current status of a customer, deleted, infringement, created, regular, VIP.                                      |
...
| Latitude                | Geographical coordinate that indicates the north-south position of a point on Earth.                                            |
| Location                | The place where the show will be realized, it will have a latitude and longitude.                                               |
| Longitude               | Geographical coordinate that indicates the east-west position of a point on Earth.                                              |
...
| Set of Keywords         | The key words of the figures.                                                                                                   |
