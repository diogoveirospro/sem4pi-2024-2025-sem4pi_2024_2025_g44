...
| CRM Manager      |                                                                                                 |
| Customer         | Represents a company or public entity interacting with Shodrone                                 |
| Customer Status  | Represents the current status of a customer                                                     |
| Description      | A textual description of a show, figure, or request                                             |
| Drone            | A specific drone unit used in performances                                                      |
| Drone Status     | Defines the current operational status of a drone                                               |
| Drone Tech       |                                                                                                 |
| DSL Code         |                                                                                                 |
...
| Public Entity    |                                                                                                 |
| Regular Client   |                                                                                                 |
| Representative   | An employee or contact of a customer                                                            |
| Serial Number    | A unique identifier for each drone                                                              |
| Shodrone         |                                                                                                 |
| Show             | An event where drones perform a sequence of figures for a customer                              |
| Show Designer    |                                                                                                 |
| Show Request     | A customer’s request for a show                                                                 |
| Show Proposal    | A proposal generated from a show request                                                        |
| Status           | Status of a show or request                                                                     |
| Test             |                                                                                                 |
