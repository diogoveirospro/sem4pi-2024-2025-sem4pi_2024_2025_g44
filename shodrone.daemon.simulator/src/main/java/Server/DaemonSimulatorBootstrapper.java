...
public class DaemonSimulatorBootstrapper {
    private static final Logger LOGGER = LogManager.getLogger(DaemonSimulatorBootstrapper.class);
    ...
    public static void main(final String[] args) {
        ...
        final SimulatorMessageParser parser = buildServerDependencies();
        ...
        final var server = new SimulatorServer(requestQueue);
    ...
    private static SimulatorMessageParser buildServerDependencies() {
        return new SimulatorMessageParser(
